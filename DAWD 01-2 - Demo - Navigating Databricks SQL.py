...
step = DA.publisher.add_step(False, instructions="""
    ...
    <h2>
        ...
        SQL Warehouses</h2>
    <div class="instructions-div">
        <p>In order to work with data in Databricks SQL, you will need to have access to a SQL Warehouse</p>
        <ol start="2">
            <li>Click "SQL Warehouses" in the sidebar menu</li>
        </ol>
        <p>There should be at least one warehouse in the list. (If not, you will need to have a Databricks Administrator configure a warehouse for you). Note the following features of the "SQL Warehouses" page:</p>
        <ul>
        ...
        <ol start="3">
            <li>Click the name of the warehouse</li>
        </ol>
        <p>Note the following features on the Warehouse's detail page:</p>
        <ul>
            <li>Overview</li>
...
step = DA.publisher.add_step(False, instructions="""
    ...
    <div class="instructions-div">
        ...
        <p>To run a query, double-check that you have an warehouse selected, type the query into the editor and click Run.</p>
...
step = DA.publisher.add_step(False, instructions="""
    ...
    <ul>
        <li>Toolbar for changing user, time span, warehouse, and status filters</li>
